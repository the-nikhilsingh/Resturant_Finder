...
$query = "SELECT count(*) FROM mains where b_id = $branch_id" ;
...
echo '<button style="margin-left:13%;"><a href="starters.php?a='.$branch_id.' ">Previous Course</a></button>';
...
<nav class="cart">
  ...
  ?>
  <br><button ><a href="specialty.php?a=<?php echo $branch_id ?> ">Continue</a></button><br>
</nav>
