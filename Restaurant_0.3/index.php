...
<?php
   ...
   if($_SERVER["REQUEST_METHOD"] == "POST") {
      ...
      $sql = "SELECT cust_id FROM customer WHERE cust_id = '$myusername' and password = '$mypassword'";
...
input:focus { box-shadow: inset 0 -5px 45px rgba(100,100,100,0.4), 0 1px 1px rgba(255,255,255,0.2); }
   ...
   <body>
     <h1 style="color:white;"> Resturant.com </h1>
<div class="login">
   <h1>Login</h1>
    <form action="prefer.php" method="post">
      ...
      <input type="submit" name="submit" value="submit "class="btn btn-primary btn-block btn-large" onclick="getLocation()">
    </form>
